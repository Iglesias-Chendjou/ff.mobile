          ...
          children: [
            ...
            Padding(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  await Clipboard.setData(ClipboardData(text: 'EFON34S'));
                },
                child: Container(
                  width: double.infinity,
                  height: 55.0,
            ...
            Padding(
              ...
              child: InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  await Clipboard.setData(ClipboardData(text: 'OWEF54LC'));
                },
                child: Container(
                  width: double.infinity,
                  height: 55.0,
