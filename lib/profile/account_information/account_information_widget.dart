...
import '/profile/upload_image/upload_image_widget.dart';
import '/profile/widget_gender_dropdown/widget_gender_dropdown_widget.dart';
import 'dart:ui';
...
class _AccountInformationWidgetState extends State<AccountInformationWidget> {
  ...
  void initState() {
    ...
    _model.textController1 ??= TextEditingController(text: 'Sophie Dupont');
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.textController2 ??=
        TextEditingController(text: 'demo@foodfirst.be');
    _model.textFieldFocusNode2 ??= FocusNode();

    _model.textController3 ??= TextEditingController(text: '32');
    _model.textFieldFocusNode3 ??= FocusNode();

    _model.textController4 ??= TextEditingController(text: '+32 470 12 34 56');
                                  ...
                                  builder: (dialogContext) {
                                    return Material(
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: WidgetGenderDropdownWidget(),
                                      ),
                                    );
                                  },
                                );
