...
import '/register/widget_loading_register/widget_loading_register_widget.dart';
import 'dart:ui';
import '/index.dart';
...
class _RegisterWidgetState extends State<RegisterWidget> {
  ...
  void initState() {
    ...
    _model.textController1 ??= TextEditingController(text: 'Oliver');
    ...
    _model.textController3 ??= TextEditingController(text: '11111111');
                            ...
                            builder: (dialogContext) {
                              return Dialog(
                                ...
                                child: GestureDetector(
                                  ...
                                  child: WidgetLoadingRegisterWidget(),
                                ),
                              );
                            },
                          );
