...
class _PaymentMethodWidgetState extends State<PaymentMethodWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (FFAppState().fromRegister2) {
        FFAppState().fromRegister2 = false;
        safeSetState(() {});
        safeSetState(
            () => _model.paymentController = createPageWalkthrough(context));
        _model.paymentController?.show(context: context);
      }
    });
  }
  ...
  TutorialCoachMark createPageWalkthrough(BuildContext context) =>
      TutorialCoachMark(
        ...
        onFinish: () async {
          safeSetState(() => _model.paymentController = null);
        },
        onSkip: () {
          return true;
        },
