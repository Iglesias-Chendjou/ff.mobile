    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            Visibility(
              visible: FFAppState().CartList.length > 0,
              child: Builder(
        ...
        body: Column(
          mainAxisSize: MainAxisSize.max,
          children: [
            if (FFAppState().CartList.length > 0)
              Expanded(
                    ...
                    children: [
                                                        ...
                                                        RichText(
                                                          ...
                                                          text: TextSpan(
                                                            children: [
                                                              TextSpan(
                                                                text:
                                                                    '\$${cartListItem.item.newPrice.toString()}  ',
                                                              ...
                                                              TextSpan(
                                                                text:
                                                                    '\$${cartListItem.item.oldPrice.toString()}',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyLarge
                                                                    .override(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              highlightColor: Colors.transparent,
                              onTap: () async {
                                if (FFAppState().CartGift) {
                                  FFAppState().CartGift = false;
                                  safeSetState(() {});
                                } else {
                                  FFAppState().CartGift = true;
                                  safeSetState(() {});
                                }
                              },
                              child: Container(
                                ...
                                height: 35.0,
                                decoration: BoxDecoration(
                                  color: FFAppState().CartGift == true
                                      ? FlutterFlowTheme.of(context).primary
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            15.0, 8.0, 15.0, 0.0),
                        child: Text(
                          'Add these top picks to your cart',
                          style: FlutterFlowTheme.of(context)
                              .titleSmall
                              .override(
                                font: GoogleFonts.inter(
                              ...
                              return Wrap(
                                ...
                                children: List.generate(mainList.length,
                                  ...
                                  return wrapWithModel(
                                    model: _model.mainCard1Models1.getModel(
                                    ...
                                    child: MainCard1Widget(
                                      key: Key(
                                        'Keycwt_${mainListIndex.toString()}',
                                      ),
                                      index: mainListIndex,
                                      data: mainListItem,
                                    ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: Image.asset(
                                  'assets/images/3f234f4wrgeg.png',
                                  width: 120.0,
                                  height: 120.0,
                                  fit: BoxFit.cover,
                                ),
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    25.0, 15.0, 25.0, 0.0),
                                child: Text(
                                  'Add products to the shopping cart to continue',
                                  textAlign: TextAlign.center,
                                  style: FlutterFlowTheme.of(context)
                                      .titleSmall
                                      .override(
                            ...
                            builder: (context) {
                              ...
                              return Wrap(
                                ...
                                children: List.generate(mainList.length,
                                  ...
                                  final mainListItem = mainList[mainListIndex];
                                  return wrapWithModel(
                                    model: _model.mainCard1Models2.getModel(
                                      mainListIndex.toString(),
                                      mainListIndex,
                                    ),
                                    updateCallback: () => safeSetState(() {}),
                                    child: MainCard1Widget(
                                      key: Key(
                                        'Keylj5_${mainListIndex.toString()}',
                                      ),
                                      index: mainListIndex,
                                      data: mainListItem,
                                    ),
