...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0DB14B);
  late Color secondary = const Color(0x210DB14B);
  late Color tertiary = const Color(0xFF06742E);
  late Color alternate = const Color(0x1D06742E);
  late Color primaryText = const Color(0xFF21201F);
  late Color secondaryText = const Color(0xFF868686);
  late Color primaryBackground = const Color(0xFFF5F4F3);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFF5F4F3);
  late Color accent2 = const Color(0xFFE9E8E7);
  late Color accent3 = const Color(0xFFF5F4F3);
  late Color accent4 = const Color(0x00000000);
  late Color success = const Color(0xFF0DB14B);
  late Color warning = const Color(0xFFFFC709);
  late Color error = const Color(0xFFFC5230);
  ...
  late Color navbarColor = const Color(0xFFADADAD);
  late Color ocean = const Color(0xFF77DDE7);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0x210DB14B);
  late Color tertiary = const Color(0xFF06742E);
  late Color alternate = const Color(0x2106742E);
  ...
  late Color accent3 = const Color(0xFF272727);
  late Color accent4 = const Color(0x00000000);
  late Color success = const Color(0xFF0DB14B);
  late Color warning = const Color(0xFFFFC709);
  late Color error = const Color(0xFFFC5230);
  ...
  late Color border = const Color(0xFF2E2E2E);
  late Color barier = const Color(0x816A6A6A);
  late Color icon = const Color(0xFF6F6F71);
  late Color borderLight = const Color(0xFF2E2E2E);
  late Color navbarColor = const Color(0xFF6C6C6C);
  late Color ocean = const Color(0xFF77DDE7);
  late Color customColor1 = const Color(0xFF303030);
}
